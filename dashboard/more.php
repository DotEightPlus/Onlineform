          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center"><?php echo $row['']." ".$row['']; ?></h3>

                <p class="text-muted text-center">Class: <?php echo $row['']; ?></p>

                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Gender.:</b> <a class="float-right"><?php echo $row['']; ?></a>
                  </li>
                  <li class="list-group-item">
                    <b>Dad No.:</b> <a class="float-right"><?php echo $row['']; ?></a>
                  </li>
                  <li class="list-group-item">
                    <b>Mum No.:</b> <a class="float-right"><?php echo $row['']; ?></a>
                  </li>
                </ul>
              </div>
              <!-- /.card-body -->
