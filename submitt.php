...
if(isset($_POST['renter_add']) || isset($_POST['rentee_add']) || isset($_POST['occ_len']) || isset($_POST['occ_date']) || isset($_POST['occ_length']) || isset($_POST['bed_num']) || isset($_POST['reason_move']) || isset($_POST['secure_depo']) || isset($_POST['pet_depo']) || isset($_POST['full_name']) || isset($_POST['adult']) || isset($_POST['children']) || isset($_POST['pet']) || isset($_POST['gender']) || isset($_POST['smoke']) || isset($_POST['add_now']) || isset($_POST['add_length']) || isset($_POST['phone']) || isset($_POST['social']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || isset($_POST['']) || ) {
